 ...
 * cash: 10000
 *
 * Why this strategy: In a clear bull trend (fast 50-day average above the slow
 * 200-day average) price tends to keep making higher highs, so we ride the
 * trend and only exit when the trend actually flips or we lose too much.
