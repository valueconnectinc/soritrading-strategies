 ...
 * name: Volume-Confirmed Panic-Bounce ATOM 4H
 * ex: binance
 * syms: ATOMUSDT
 * interval: 4h
 * cash: 10000
 *
 * Why this strategy: Mean-reversion family, distinct refinement of the
 * validated band-bounce champion. ATOM 4h overreacts to the downside, touches
 ...
 * snap-back live. On AVAX this cut trade count in half, lowered MDD on every
 * window, and improved returns on 2/3 windows vs the plain champion.
 ...
 * falling still loses. Volume confirmation means fewer trades, so it may miss
 * shallow dips that would have recovered. Mean reversion is defensive.
 */
