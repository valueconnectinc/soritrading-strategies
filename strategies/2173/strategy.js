 ...
 * crash. A 100-day price-trend guard (faster than 200) is meant to protect the
 * bear while whipsawing less than a 200-day guard in a choppy bull.
 ...
 * the hash rate turns down or price closes below the 100-day average.
 * When it does NOT work: a 100-day average is more sensitive, so it can
 * whipsaw in sideways markets and miss the start of a recovery; halving
 * events distort the hash-rate trend.
 */
