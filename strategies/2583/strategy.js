 ...
 * regimes we WIDEN the exit to a 60-day low (hold through normal bull pullbacks
 * but still bail on deeper corrections); in hiking regimes we keep the tight
 * 30-day exit. v2 uses widening instead of fully disabling the exit, because
 * fully disabling rode through real crashes (2018, 2020 COVID) during easing.
 ...
 * noisy it may hold through a top that the 30-day exit would have caught. This
 * is a macro-hybrid, not a pure price strategy.
 */
