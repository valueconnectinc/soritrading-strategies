 ...
 * name: Champion v2 LTC 1D Generalization
 * ex: binance
 * syms: LTCUSDT
 * interval: 1d
 * cash: 10000
 ...
 * on LTC daily bars — an asset NEVER used for tuning. If the fear-depth crash-defense
 * edge is real and not fitted to BTC/ETH, it should transfer to LTC.
