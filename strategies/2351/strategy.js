 ...
 * EXACT same logic to BNB — a high-price major never validated for this family.
 * BNB's high price (~$300-600) keeps the daily-rebalance quantity small, so the
 * fee-destruction that killed the LTC/ADA ports should not apply here.
