 ...
 * cash: 10000
 *
 * Why this strategy: Same validated band-bounce mean-reversion recipe as XRP 1D —
 *   buy deep oversold dips below the lower Bollinger band, exit on recovery.
 *   Tests whether the edge generalizes to another mean-reverting alt at 1d.
 ...
 * When it does NOT work: Sustained multi-week downtrends (re-buys falling knives)
 *   and fast melt-ups (exits too early).
 */
