 ...
 * name: BNB Regime-Adaptive Vol-Target 1D
 * ex: binance
 * syms: BNBUSDT
 * interval: 1d
 * cash: 10000
 *
 * Why this strategy: the trend-gated vol-target logic is a validated champion on
 * BTC, ETH, SOL and XRP (beats buy-and-hold on all walk-forward windows). This
 * ports the EXACT same logic to BNB 1D to test whether the edge generalizes to a
 * fifth asset. Bet: a liquid major trends above its 50-SMA and scaling position
 * by how far above it (with a crash stop) captures upside while capping drawdown.
 ...
 * position, and choppy flat regimes cause repeated small rebalancing.
 */
