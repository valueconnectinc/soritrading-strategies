 ...
 * average) and a crash stop cut the worst drawdowns. Sizing down in high volatility
 ...
 * make a new high (MDD can reach ~60%). Long-only, so it does not profit from shorting
 * bear markets.
 */
