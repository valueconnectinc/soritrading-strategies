 ...
 * name: Band-Bounce Mean Reversion BNB 4H
 * ex: binance
 * syms: BNBUSDT
 * interval: 4h
 * cash: 10000
 ...
 * applied to BNB 4h to test whether the family's defensive generalization
 * extends to another large-cap. Buys rare panic bottoms above the 200-SMA.
 * When it buys and sells: buys when price closes below the lower Bollinger(20,2)
 * with RSI<30 while above the 200-SMA; exits at the middle band / RSI>50 or a
 * 6-ATR stop; waits 5 bars before re-entering.
