 ...
 * name: XRP Band Bounce On-Chain Filter 4H
 * ex: binance
 * syms: XRPUSDT
 * interval: 4h
 * cash: 1000
 *
 * Why this strategy: XRP 4h band-bounce is a validated defensive winner in the
 * same family as LTC/DOT. This version adds an on-chain network-health filter
 * (BTC active addresses above their rolling average) to test whether it helps
 * the third validated asset)Skip. This completes the A/B on the on-chain filter
 * axis across LTC (inconclusive), DOT (worse), and XRP.
