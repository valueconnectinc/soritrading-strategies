 ...
 * name: Band-Bounce Mean Reversion BCH 1D
 * ex: binance
 * syms: BCHUSDT
 * interval: 1d
 * cash: 10000
 *
 * Why this strategy: The band-bounce mean-reversion champion, validated on 4h across
 * 25+ assets. BCH 4h already confirmed the family. Testing the SAME recipe on BCH
 * DAILY bars to check whether the mean-reversion edge is timeframe-robust (extends
 * from 4h to 1d), alongside XRP 1d which just confirmed it makes money 2/2.
