 ...
 * name: ETH Trend Donchian-10 Breakout Entry 1D
 * ex: binance
 * syms: ETHUSDT
 * interval: 1d
 * cash: 10000
 *
 * Why this strategy: The 20-day Donchian breakout variant cut whipsaw and MDD a lot
 * (2018-21: +212% vs champion +144%, MDD 44% vs 61%) but gave up bull upside in
 * 2024-26 (+33% vs +69%) because the 20-day window delays re-entry at recoveries.
 * This variant uses a SHORTER 10-day breakout window so it re-enters faster after a
 * pullback, keeping more of the bull participation while still filtering out the
 * worst chop bounces.
 ...
 * When it does NOT work: A 10-day window is looser, so it still buys some chop bounces
 * and can whipsaw in flat markets; and it is long-only, so it does not profit from
