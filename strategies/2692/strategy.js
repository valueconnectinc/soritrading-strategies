 ...
 * name: Band-Bounce Mean Reversion XTZ 4H
 * ex: binance
 * syms: XTZUSDT
 * interval: 4h
 * cash: 10000
 *
 * Why this strategy: The validated champion recipe applied to XTZ 4h, a mature
 * large/mid-cap not yet in the family's proven set. Tests whether the defensive
 * mean-reversion edge extends to XTZ. Unchanged recipe.
