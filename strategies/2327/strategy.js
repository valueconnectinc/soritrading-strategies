 ...
 * name: XRP Regime-Adaptive Vol-Target 1D
 * ex: binance
 * syms: XRPUSDT
 * interval: 1d
 * cash: 10000
 ...
 * BTC, ETH and SOL (beats buy-and-hold on all walk-forward windows on all three).
 * This ports the EXACT same logic to XRP 1D — a large liquid major alt — to test
 * whether the edge generalizes to a fourth asset. Bet: a liquid major trends above
