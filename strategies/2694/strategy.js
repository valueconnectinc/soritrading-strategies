 ...
 * name: Band-Bounce Mean Reversion AAVE 4H
 * ex: binance
 * syms: AAVEUSDT
 * interval: 4h
 * cash: 10000
 *
 * Why this strategy: The validated champion recipe applied to AAVE 4h, a mature
 * DeFi large/mid-cap not yet in the family's proven set. Tests whether the
 * defensive mean-reversion edge extends to AAVE. Unchanged recipe.
