 ...
 * name: Band-Bounce Mean Reversion DOGE/ETC 4H
 * ex: binance
 * syms: DOGEUSDT, ETCUSDT
 * interval: 4h
 * cash: 10000
 *
 * Why this strategy: Mean-reversion family, exact champion recipe transferred to
 * fresh assets (DOGE, ETC). These 4h pairs overreact to the downside, touch the
 * lower Bollinger band, then snap back to the mean. Buying the panic-bottom and
 * selling back to the middle captures the snap-back. A 5-bar re-entry cooldown
 * after each exit spaces out repeated falling-knife buys.
