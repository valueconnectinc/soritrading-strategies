 ...
 * name: BTC Regime Trend Champion 1D (pure)
 * ex: binance
 * syms: BTCUSDT
 * interval: 1d
 * cash: 10000
 *
 * Why this strategy: Pure price-only regime-trend recipe (no on-chain lever) on BTC,
 * used as the control to isolate whether the on-chain sizing lever helps or hurts.
 * The bet: crypto trends persist for months, so riding price above its 50-day average
 * captures most of the upside, while a hysteresis exit (1 ATR below) and a crash stop
 * cut the worst drawdowns.
