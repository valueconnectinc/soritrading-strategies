 ...
 * name: Squeeze Breakout BTC 4H (Risk-Sized + MACD Gate)
 * ex: binance
 * syms: BTCUSDT
 * interval: 4h
 * cash: 10000
 *
 * Why this strategy: The squeeze-breakout champion recipe (validated on ETH 4h,
 * generalized to SOL 4h) is tested here on BTC 4h — a fresh asset for this
 * family. It buys volatility squeezes that resolve upward inside an uptrend.
 ...
 * 20-bar average AND price is above the 200-bar SMA AND MACD is above its
 * signal. Position risks 2% of equity on the 2.5x-ATR stop. Exits on a
 * 2.5x-ATR stop or a 20-bar low trail.
 ...
 * lags the biggest melt-up rallies.
 */
