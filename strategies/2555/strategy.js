 ...
 * name: Champion v2 OOS LINK 4H
 * ex: binance
 * syms: LINKUSDT
 * interval: 4h
 * cash: 10000
 *
 * Why this strategy: Pure OOS validation of the validated champion v2 (fear-depth
 * two-tier contrarian + trend-pullback hybrid) on LINK 4h — an asset never used in
 * tuning. Confirms the fear-contrarian edge generalizes beyond BTC/ETH/SOL/XRP.
 ...
 * straight through the 50-EMA gives the trend leg no entry.
 */
