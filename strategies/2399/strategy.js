 ...
 * name: LTC Regime Trend Champion 1D
 * ex: binance
 * syms: LTCUSDT
 * interval: 1d
 * cash: 10000
 ...
 * SOL, BNB, ADA and XRP (no parameter tuning) — applied here to LTC as a fresh-asset
 * robustness check. The bet: crypto trends persist for months, so riding price above
