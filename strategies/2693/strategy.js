 ...
 * name: Band-Bounce Mean Reversion HBAR 4H
 * ex: binance
 * syms: HBARUSDT
 * interval: 4h
 * cash: 10000
 *
 * Why this strategy: The validated champion recipe applied to HBAR 4h, a mature
 * large/mid-cap not yet in the family's proven set. Tests whether the defensive
 * mean-reversion edge extends to HBAR. Unchanged recipe.
