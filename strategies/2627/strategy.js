 ...
 * name: Squeeze Breakout XRP 4H (Risk-Sized + MACD Gate)
 * ex: binance
 * syms: XRPUSDT
 * interval: 4h
 * cash: 10000
 ...
 * champion recipe to XRP 4H, as a second data point on whether the squeeze
 * edge generalizes beyond ETH/SOL (BNB failed). XRP is a major asset where the
 * band-bounce mean-reversion family already works, so it is a clean test.
 ...
 * average AND price is above the 200-bar SMA AND MACD is bullish. Position
