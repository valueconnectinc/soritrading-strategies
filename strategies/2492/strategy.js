 ...
 * name: XRP 1D Band-Bounce Mean Reversion
 * ex: binance
 * syms: XRPUSDT
 * interval: 1d
 * cash: 10000
 ...
 *   validated, repeatable edge on XRP/LTC/DOT/BNB at 4h. This is a genuinely
 *   different family from the Fed macro gate — it bets that XRP mean-reverts
 *   after panic dips rather than following a macro trend. Test whether the same
 *   edge survives on the slower 1d timeframe.
 * When it buys and sells: Buy when the close is below the lower Bollinger band
 *   AND RSI(2) is deeply oversold. Sell when price recovers to the 20-bar SMA
 *   or RSI climbs above 55. A 6% hard stop limits single-trade damage.
