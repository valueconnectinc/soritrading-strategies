 ...
 * name: LTC Trend-Gated Vol-Target TrendScaled 1D
 * ex: binance
 * syms: LTCUSDT
 * interval: 1d
 * cash: 10000
 *
 * Why this strategy: generalization test of the job's most validated family
 * (SMA50 gate + ATR vol-target + ATR crash stop + trend-strength scaling) on LTC,
 * a major coin never before tested. The exact recipe (zero tuning) already beat
 * buy-and-hold on BTC/ETH/SOL/DOGE with MDD cut from 60-85% to 30-54%.
 * When it buys and sells: above SMA50 = fully invested; below SMA50 = position
 * scaled by closeness to SMA50; beyond the 3xATR crash band = cash.
