 ...
 * position but tames drawdown with a steep-downtrend filter that refuses to
 * buy breakouts while price is crashing, plus a 3x-ATR disaster stop. Both
 * tools improved on plain Donchian on every window.
 ...
 * markets (whipsawed by the wide channel) and carries high drawdown in sharp
 * reversals — it is a higher-risk trend strategy, not a defensive one.
 */
function onUpdate(ctx) {
  ...
  // 50-EMA — those breakouts are bull traps in a crash.
