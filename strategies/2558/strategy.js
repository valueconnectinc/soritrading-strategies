 ...
 * name: Champion v2 OOS ADA 4H
 * ex: binance
 * syms: ADAUSDT
 * interval: 4h
 * cash: 10000
 *
 * Why this strategy: Fresh OOS validation of the validated champion v2 (fear-depth
 * two-tier contrarian + trend-pullback hybrid) on ADA 4h — an asset never used in
 * tuning. Confirms the fear-contrarian edge generalizes to another asset.
