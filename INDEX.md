...
**★ marks a strategy that out-returned buy & hold over the same window** — 16 of 179 right now.
`—` means the comparison **could not be made**: the engine does not compute a benchmark for multi-symbol, futures, or multi-leg runs. That is *unknown*, not *lost*, and it is 97 of them right now.

Every figure comes from the last verifying backtest at publish time. These are past results over historical data. Nothing here is promised or assured about the future, and none of it is investment advice.

| | ID | Name | Return | Buy & hold | MDD | Trades | Updated |
|:-:|---:|---|---:|---:|---:|---:|---|
| — | [970](strategies/970/) | Bollinger Band Mean Reversion Strategy | -1.98% | — | +26.25% | 249 | 2026-09-16 |
