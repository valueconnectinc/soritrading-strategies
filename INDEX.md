...
**★ marks a strategy that out-returned buy & hold over the same window** — 49 of 338 right now.
`—` means the comparison **could not be made**: the engine does not compute a benchmark for multi-symbol, futures, or multi-leg runs. That is *unknown*, not *lost*, and it is 151 of them right now.
